...
function CropIcon() {
	return (
		<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
			<path stroke-linecap="round" stroke-linejoin="round" d="M7 7V3M7 7H3M7 7L21 21M17 17H21M17 17V21M17 17L3 3" />
		</svg>
	);
}
...
function ToolbarButton({ icon, label, onClick, active = false }: ToolbarButtonProps) {
	return (
		<button
			onClick={onClick}
