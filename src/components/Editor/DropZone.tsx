  ...
  return (
    <div class="relative w-full h-full overflow-hidden">
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-amber-100 via-orange-50 to-rose-100">
        ...
        <div
          class="absolute top-[-10%] right-[10%] w-[40vw] h-[40vw] max-w-[500px] max-h-[500px]
        ...
        />
        <div
          class="absolute bottom-[-5%] left-[-5%] w-[35vw] h-[35vw] max-w-[400px] max-h-[400px]
					rounded-[60%_40%_30%_70%/60%_30%_70%_40%]
					bg-gradient-to-tr from-rose-200/50 to-pink-300/30
					blur-3xl animate-[blobFloat2_25s_ease-in-out_infinite]"
        />
        <div
          class="absolute top-[40%] left-[60%] w-[25vw] h-[25vw] max-w-[300px] max-h-[300px]
        ...
        >
          ...
          <div class="p-8">
            <div class="grid grid-cols-2 gap-4 mb-6">
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-white shadow-sm border border-zinc-100
									flex items-center justify-center
									group-hover:shadow-md group-hover:border-amber-200 group-hover:scale-105
									transition-all duration-200"
                >
                  <svg
                    class="w-6 h-6 text-zinc-400 group-hover:text-amber-500 transition-colors"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
              ...
              >
                ...
                >
                  {isLoadingDemo ? (
                    ...
                    <svg
                      class="w-6 h-6 text-zinc-400 group-hover:text-rose-500 transition-colors"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      stroke-width="1.5"
            ...
            {isDragging && (
              <div
                class="absolute inset-4 rounded-2xl border-2 border-dashed border-amber-400 bg-amber-50/80 backdrop-blur-sm
								flex items-center justify-center z-20 pointer-events-none animate-[fadeIn_0.15s_ease-out]"
              >
                <div class="text-center">
                  <div
                    class="w-16 h-16 mx-auto mb-3 rounded-2xl bg-amber-100
