...
import { aiPrompt, aiGenerating, aiBackground, backgroundType } from '../../store/editor';
	...
	return (
		<div class="flex flex-col gap-3">
			<div class="flex items-center gap-2">
				...
				<span class="text-[10px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded font-medium">Beta</span>
			</div>
			...
			<div class="flex gap-2">
				<input
					...
					onInput={(e) => (aiPrompt.value = (e.target as HTMLInputElement).value)}
