...
function LiquidGlassBackground() {
	return (
		<div class="absolute inset-0 overflow-hidden">
			...
			<div class="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] max-w-[800px] max-h-[800px]
			...
			<div class="absolute bottom-[-15%] right-[-10%] w-[50vw] h-[50vw] max-w-[700px] max-h-[700px]
			...
			<div class="absolute top-[30%] right-[20%] w-[35vw] h-[35vw] max-w-[500px] max-h-[500px]
			...
			<div class="absolute bottom-[20%] left-[15%] w-[30vw] h-[30vw] max-w-[400px] max-h-[400px]
			...
			<div class="absolute top-[10%] left-[30%] w-[40vw] h-[1px]
				bg-gradient-to-r from-transparent via-white/40 to-transparent
				rotate-[-15deg] blur-[1px] animate-[shimmerStreak_8s_ease-in-out_infinite]" />

			<div class="absolute bottom-[25%] right-[25%] w-[30vw] h-[1px]
...
export default function Editor() {
	...
	const [sidebarWidth, setSidebarWidth] = useState(() => {
		if (typeof window !== 'undefined') {
			return parseInt(localStorage.getItem('sidebar-width') || String(DEFAULT_SIDEBAR_WIDTH));
		}
	...
	return (
		<div class="h-screen w-screen relative">
			...
			<div class="relative z-10 h-full w-full p-3">
				...
				>
					{/* Canvas Area */}
					<main class="flex-1 flex items-center justify-center overflow-auto custom-scrollbar
