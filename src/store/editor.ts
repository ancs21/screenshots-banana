...
// Background
export const backgroundType = signal<'gradient' | 'pattern' | 'image' | 'ai'>('gradient');
...
// Canvas size presets
export type CanvasPreset = 'auto' | 'free' | 'tweet' | 'instagram' | 'instagram-story' | 'appstore';
...
export const canvasSizes: Record<Exclude<CanvasPreset, 'free'>, { width: number; height: number } | null> = {
	auto: null,
